...
Las preferencias de tema, modelo e inyección automática se almacenan localmente. La API key introducida en la interfaz solo permanece durante la sesión y no se guarda en las preferencias. También puede proporcionarse mediante la variable de entorno `GEMINI_API_KEY`.
