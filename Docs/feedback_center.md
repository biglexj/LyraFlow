...
- Todas las aplicaciones DEBEN enlazar directamente al repositorio oficial del proyecto en **GitHub Issues** (`https://github.com/biglexj/LyraFlow/issues`).
...
- **Paso de Metadatos vía URL/JSON**:
  ...
  - `app`: Nombre de la aplicación (ej. `LyraFlow`).
