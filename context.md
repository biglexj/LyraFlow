...
- **Flujo**: El usuario dicta por micrófono → un proveedor multimodal (Gemini u OpenAI-compatible) contextualiza, o Whisper local transcribe → se inyecta en el chat/editor activo.
