...
- [ ] Integración con el Centro de Feedback oficial (`https://www.biglexj.com/feedback`) enviando parámetros de contexto (app, versión, OS) con fallback provisional a GitHub Issues.
...
## 🟢 Completado
- [x] **v1.1.0** (2026-08-01) — Asistente de transcripción multimodal & dictado inteligente offline / cloud con Drag & Drop, pestaña de Historial Temporal, gestión de retención, Pestañas de System Prompt (*Voz Original* vs *Inteligente*), Single-Instance Lock por socket local y migración reactiva de API Key.
