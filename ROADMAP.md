...
- [ ] Validar manualmente cada endpoint multimodal configurado por el usuario en Windows.
...
## 🟢 Completado
- [x] **v1.1.0** (2026-08-01) — Asistente de transcripción multimodal & dictado inteligente offline / cloud con Drag & Drop, pestaña de Historial Temporal, gestión de retención y bloqueo autónomo sin API Key.
...
- [x] Añadir adaptador OpenAI-compatible con endpoint y modelo editables.
